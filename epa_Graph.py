...
ax1.set_xlabel("Day of 2025", fontweight="bold")
ax1.set_ylabel("Ozone (ppm)", fontweight="bold")
ax1.set_ylim(0,.09)
ax1.set_title("Valparaiso EPA Ozone Data\nwith Sunrise/Sunset Markers (2026)", fontweight="bold")
ax1.legend()

plt.savefig("epa_ozone_2025.png", bbox_inches="tight", dpi=600)
plt.show()
